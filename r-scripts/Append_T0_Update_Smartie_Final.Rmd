...
temp$gbifapi_scientificName <- ifelse(temp$gbifapi_scientificName == "Ludwigia grandiflora (Michx.) Greuter & Burdet.", "Ludwigia grandiflora (Michaux) Greuter & Burdet
", temp$gbifapi_scientificName)
