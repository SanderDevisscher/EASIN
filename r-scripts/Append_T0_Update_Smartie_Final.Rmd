...
SMARTIE_FINAL2$geometry <- NA
SMARTIE_FINAL2$year <- lubridate::year(SMARTIE_FINAL2$eventDate)
SMARTIE_FINAL2$gis_utm1_code <- NA
SMARTIE_FINAL2$type <- NA
SMARTIE_FINAL2$scientificNameID <- NA
SMARTIE_FINAL2$license <- NA
SMARTIE_FINAL2$scientificNameAuthorship <- NA
SMARTIE_FINAL2$source <- "SMARTIE"
SMARTIE_FINAL2$accessRights <- NA
SMARTIE_FINAL2$ownerInstitutionCode <- NA
SMARTIE_FINAL2$gbifID <- NA
SMARTIE_FINAL2$rightsHolder <- NA
SMARTIE_FINAL2$language <- NA
SMARTIE_FINAL2$waterBody <- NA
SMARTIE_FINAL2$gis_EUgrid_cellcode <- NA
SMARTIE_FINAL2$organismQuantityType <- NA
SMARTIE_FINAL2$gis_bioregion_code <- NA
